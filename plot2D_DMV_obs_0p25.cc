...
void plot2D_DMV_obs_0p25(TString myfolder = "", TString tag="")
{
    ...
    TGraph* exclusion_exp          = InterpolateDM(tag, h_Limit_exp     , 1, 10, 450, 0, 150);
    TGraph* exclusion_p1s          = InterpolateDM(tag, h_Limit_p1s     , 1, 10, 450, 0, 150);
    TGraph* exclusion_m1s          = InterpolateDM(tag, h_Limit_m1s     , 1, 10, 450, 0, 150);
    TGraph* exclusion_obs          = InterpolateDM(tag, h_Limit_obs     , 1, 10, 450, 0, 150);
    TGraph* exclusion_obs_theo_p1s = InterpolateDM(tag, h_Limit_theo_p1s, 1,  1, 450, 0, 150);
    TGraph* exclusion_obs_theo_m1s = InterpolateDM(tag, h_Limit_theo_m1s, 1,  1, 450, 0, 150);
    ...
    if( tag == "MV" ) addText(0.18,0.42,0.835-0.1,0.898-0.1,"Vector, g_{q}=0.25",kBlack);
    if( tag == "MA" ) addText(0.18,0.42,0.835-0.1,0.898-0.1,"Axial Vector, g_{q}=0.25",kBlack);;
