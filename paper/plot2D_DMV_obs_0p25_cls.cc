...
void plot2D_DMV_obs_0p25_cls(TString myfolder = "", TString tag="", bool savePlots=true)
{
    ...
    TGraph * h_relic2 = new TGraph("list_scan_V_g25_MD_xxd_V_gq0.25_gdm1.0_contour_10.txt");
    ...
    addText(0.5,0.84,0.34,0.44,"#Omega_{c} #times h^{2} = 0.12",getRelicColor(), 35, 0.04);
