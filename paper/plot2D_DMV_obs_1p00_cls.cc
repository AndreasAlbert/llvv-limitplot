...
void plot2D_DMV_obs_1p00_cls(TString myfolder = "", TString tag="", bool savePlots=true)
{
    ...
    TGraph * h_relic2 = new TGraph("list_scan_V_g25_MD_xxd_V_gq1.0_gdm1.0_contour_10.txt");
    ...
    addText(0.53,0.83,0.2,0.3,"#Omega_{c} #times h^{2} = 0.12",getRelicColor(), 12, 0.04);
