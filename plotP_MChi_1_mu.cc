...
using namespace std;
double XS[10] ={0.010200492826360,0.010127409943178,0.009716687554130,0.008792934664046,0.002543656793448,0.001481521326550,0.000683168065113,0.000323108414976,0.000070242255862,0.000021620355725};//,1.502e-01};

void plotP_MChi_1_mu(TString myfolder = "")
{


    TString tag = "";
    if(myfolder.Contains("/NLOP")) tag="NLOP";
  ...
  TLegend *leg = new TLegend(0.60,0.72,0.90,0.92,NULL,"brNDC");
   ...
   pt->SetTextFont(42);
   pt->SetTextSize(0.03);
   TText *AText = pt->AddText("#splitline{Pseudoscalar mediator, g_{q} = 1.0}{Dirac DM, #it{m}_{DM} = 1 GeV, g_{DM} = 1.0 }");
   ...
   pt->Draw();
    ...
    canv->SaveAs("mu_13TeV_NLOP_Mchi_1.png");
    canv->SaveAs("mu_13TeV_NLOP_Mchi_1.pdf");
}
